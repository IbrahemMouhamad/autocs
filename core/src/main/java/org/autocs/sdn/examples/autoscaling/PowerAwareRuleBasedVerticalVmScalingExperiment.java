...
public class PowerAwareRuleBasedVerticalVmScalingExperiment extends BasicPowerAwareExperiment {

    protected PowerAwareRuleBasedVerticalVmScalingExperiment(int index,
            PowerAwareRuleBasedVerticalVmScalingExperimentRunner runner,
            final long seed,

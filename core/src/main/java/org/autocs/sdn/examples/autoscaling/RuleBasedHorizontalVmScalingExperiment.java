...
public class RuleBasedHorizontalVmScalingExperiment extends BaseExperiment {

    protected RuleBasedHorizontalVmScalingExperiment(int index,
            RuleBasedHorizontalVmScalingExperimentRunner runner,
            final long seed,

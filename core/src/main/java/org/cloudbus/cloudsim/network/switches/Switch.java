...
import org.autocs.sdn.data.networkelement.resources.NetworkElementStatsComputer;
...
public interface Switch
        extends NetworkElement, SimEntity, PowerAware<PowerModelSwitch>,
        NetworkElementStatsComputer<SwitchResourceStats> {
    ...
    /**
     * Gets the bandwidth this Switch has to communicate with Switches in the upper
     * layer.
     * 
    ...
    /**
     * Sets the bandwidth this Switch has to communicate with Switches in the upper
     * layer.
     * 
    ...
    /**
     * Gets the bandwidth this Switch has to communicate with Switches in the lower
     * layer.
     * 
    ...
    /**
     * Sets the bandwidth this Switch has to communicate with Switches in the lower
     * layer.
     * 
    ...
    /**
     * Gets the latency time the switch spends to process a received packet. This
     * time is
    ...
    /**
     * Sets the latency time the switch spends to process a received packet. This
     * time is
     * considered constant no matter how many packets the switch have to
     * process (in seconds).
     * 
    ...
    /**
     * Gets the list of Switches in the upper layer that this Switch is connected
     * to.
     * 
     * @return
     */
    ...
    /**
     * Gets the list of Switches in the lower layer that this Switch is connected
     * to.
     * 
     * @return
     */
     ...
     * depending on whether it is a {@link RootSwitch} (layer 0),
     * {@link AggregateSwitch} (layer 1)
    ...
    /**
     * Gets the {@link PowerModelSwitch} used by the switch
     * to define how it consumes power.
     * A Switch just provides power usage data if a PowerModel is set.
     *
     * @return the Switch's {@link PowerModelSwitch}
     */
    PowerModelSwitch getPowerModel();

    /**
     * Sets the {@link PowerModelSwitch} used by the switch
     * to define how it consumes power.
     * A Switch just provides power usage data if a PowerModel is set.
     *
     * @param powerModel the {@link PowerModelSwitch} to set
     * @return
     */
    void setPowerModel(PowerModelSwitch powerModel);

    /**
     * Enables storing Switch state history.
     * 
     * @see #getStateHistory()
     */
    ...
    /**
     * Disable storing Switch state history.
     * 
     * @see #getStateHistory()
     */
    ...
    /**
     * Checks if Switch state history is being collected and stored.
     * 
     * @return
     */
    ...
    /**
     * Gets a <b>read-only</b> switch state history.
     * This List is just populated if {@link #isStateHistoryEnabled()}
     *
     * @return the state history
     * @see #enableStateHistory()
     */
    List<NetworkElementStateEntry> getStateHistory();
    ...
    /**
     * Gets {@link NetworkElementStateEntry} in the current moment
     *
     * @return
     */
    NetworkElementStateEntry getSateEntrySoFar();
}
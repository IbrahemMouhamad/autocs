...
/**
 * Represents matrix containing the delay (in seconds) between every pair or
 * nodes
...
public class DelayMatrix {
	...
	/**
	 * The predecessor matrix (used to get the shortest path).
	 */
	private int[][] pk;
	 ...
	 * @param directed indicates if a directed matrix should be computed (true) or
	 *                 not (false)
	 */
	 ...
	 *
	 * @param graph    the network topological graph
	 * @param directed indicates if an directed matrix should be computed (true) or
	 *                 not (false)
	 */

...
/**
 * Represents a packet that travels from a {@link NetworkVm} to another, through
 * the virtual network
 * within a {@link NetworkHost}. It contains information about
 * {@link NetworkCloudlet}s which are
 * communicating.
 *
 * <p>
...
public class VmPacket implements NetworkPacket<NetworkVm> {
    ...
    /**
     * flow id which this packet is belong to, used in SDN forwarding table
     */
    private long flowId;
     ...
     * @param flowId           flow id which this packet is belong to, used in SDN
     *                         forwarding table
